...
%prep
%setup -q -n openshot-qt-2.6.1
cd %{_builddir}/openshot-qt-2.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632154449
...
cp %{_builddir}/openshot-qt-2.6.1/images/Humanity/COPYING %{buildroot}/usr/share/package-licenses/openshot-qt/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/openshot-qt-2.6.1/src/resources/license.txt %{buildroot}/usr/share/package-licenses/openshot-qt/c1d5663b31d3742b9487146938059a539e4b4b29
